...
class UserstreamAPIClientTests: XCTestCase {
    ...
    func testConvertRetweet() {
        ...
        XCTAssertEqual(convertRetweet.objectForKey("user")?.objectForKey("profile_image_url") as? String, "https://whalebird.org/original", "retweeted original profile image should fixed")
        ...
        XCTAssertEqual(convertRetweet.objectForKey("retweeted")?.objectForKey("profile_image_url") as? String, "https://whalebird.org/retweet", "retweeted profile image should fixed")
    }
}
